...
void Sam::draw(Maths::Mat4 &viewMatrix, Maths::Mat4 &projMatrix, Maths::Mat4 matrix)
{
	...
	glUniformMatrix4fv(shader->getShaderProjectionMatrixLocation(), 1, GL_TRUE, projMatrix.getMatrixArray());
